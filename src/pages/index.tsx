...
import Addressable from '../assets/addressable.png'
import Dappradar from '../assets/dappradar.png'
import Messari from '../assets/messari.png'
...
const Index = () => {
  return (
    <div className="h-full w-full bg-black text-white min-h-[100dvh] overflow-x-hidden">
      ...
      <div className="relative w-full px-">
       ...
       <div className="px-4">
        <div className="flex max-lg:flex-col gap-10 justify-center items-center pt-32 md:pt-42 pb-10 px-6 w-full max-w-7xl mx-auto">
          <div className="md:max-w-xl lg:max-w-xl md:px-4 backdrop-blur-[3px]" data-aos="fade-up-right">
        ...
        <div className="w-full max-w-7xl mx-auto mb-20 mt-10 md:px-4 backdrop-blur-[2px] overflow-x-auto">
          <p className="py-2 text-center text-lg font-barmo text-[rgb(85,85,85)]">
            Powered by the Most Sought After Tools
          </p>
          <div className="max-xl:scroll-container" data-aos="fade-left">
            <div className="lg:scroll-text2 scroll-text">
              <div className="flex items-center gap-10">
                ...
                <div className="shrink-0">
                  <img src={ClayLogo} alt="Clay" className="h-15" />
                </div>
                <div className="shrink-0">
                  <img src={Airtable} alt="Airtable" className="h-12" />
                </div>
                <div className="shrink-0">
                  <img src={SmartLeadAILogo} alt="SmartLeadAI" className="h-14" />
                </div>
                <div className="shrink-0">
                  <img src={RootDataLogo} alt="RootData" className="h-15" />
                </div>
                <div className="shrink-0">
                  <img src={FeedHiveLogo} alt="FeedHive" className="h-14" />
                </div>
                <div className="shrink-0">
                  <img src={Dappradar} alt="Dappradar" className="h-12" />
                </div>
                <div className="shrink-0">
                  <img src={Messari} alt="Messari" className="h-12" />
                </div>
                <div className="shrink-0">
                  <img src={Dune} alt="Dune" className="h-16" />
                </div>
                <div className="shrink-0">
                  <img src={Addressable} alt="Addressable" className="h-10" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-6xl mx-auto py-10 lg:py-20 my-10 border border-secondary bg-secondary/20 backdrop-blur-sm p-6 rounded-xl z-10" data-aos="zoom-out">
        ...
        <div className="w-full max-w-6xl mx-auto py-10"> 
          <p className="font-barmo text-3xl md:text-4xl pt-14" data-aos="zoom-in-down">Why TRACTION3 Works?</p>
        ...
        <div className="w-full max-w-5xl mx-auto py-10">
          <p className="font-barmo text-3xl md:text-5xl pt-14 text-center" data-aos="zoom-out-down">GTM Packages Built for Web3</p>
          <div className="space-y-6 py-10">
            <Card2 title="Startup Pack" icon={startupPic} direction="left">
              ...
              <ul className="list-disc space-y-2 text-sm">
                ...
                <li>BD Lead Generation System</li>
                <li>Outbound Automation / Real Time CRM Leads Update</li>
        ...
        <div className="w-full max-w-5xl mx-auto py-10 md:px-4">
          <div className="flex max-md:flex-col gap-5 justify-between items-center">
            <p className="font-barmo text-4xl max-md:text-center md:max-w-sm" data-aos="fade-down-right">Let's Replicate these Results for You</p>
            <p className="font-extralight max-md:text-center text-sm md:max-w-sm" data-aos="fade-down-left">We have worked with various web3 projects, Here are some reviews and testimonials of our previous works</p>
          </div>
          <div className="flex max-md:flex-col gap-10 pt-10 md:space-x-2 justify-around md:pt-20 items-center">
            <div className="flex flex-col justify-center items-center max-w-[280px]" data-aos="flip-up">
          ...
          <div className="py-10 mt-20">
            <p className="font-barmo text-4xl text-center" data-aos="fade-down">Real founders, Real Wins.</p>
            <div className="flex max-md:flex-col justify-center items-center gap-5 py-10">
              <div className="border shadow-2xl shadow-secondary/40 border-secondary backdrop-blur-xs bg-secondary/10 p-5 flex gap-4 justify-center items-center rounded-2xl max-w-lg" data-aos="fade-right">
                <div>
              ...
              <div className="border border-secondary shadow-2xl shadow-secondary/40 backdrop-blur-xs bg-secondary/10 p-5 flex gap-4 justify-center items-center  rounded-2xl max-w-lg" data-aos="fade-left">
                 <div>
        ...
        <div className="w-full max-w-6xl mx-auto py-20 px-2 shadow-2xl shadow-white/10 sm:px-8 flex justify-center items-center flex-col bg-gradient-to-bl from-secondary/40 via-primary/40 to-secondary/40 backdrop-blur-xs rounded-3xl space-y-8" data-aos="flip-down">
        ...
        {/* Footer */}
        <div className='pt-20 lg:px-20 max-w-6xl mx-auto px-10' data-aos="fade-up">
            <div className='flex flex-col sm:flex-row justify-between items-center pb-10'>
              ...
              <div className='max-sm:pt-8'>
                ...
                <div>
              <a href="http://x.com/traction_3" className=' hover:text-primary'>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"  viewBox="0 0 16 16">
